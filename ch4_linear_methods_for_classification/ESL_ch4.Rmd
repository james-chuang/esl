...
Logistic regression- model the posterior probabiltiies of the $K$ classes via linear functions in $x$, while ensuring that they sum to one and remain in $[0,1]$ (so that they can be interepreted as probabiltiies). The model:
$$
\begin{align}
