...
```{r linear model, fig.align='center', fig.cap='Classification by linear regression. The orange shaded region represents points that will be classified as $\\color{darkorange}{\\texttt{ORANGE}}$, while the blue region will be classified as $\\color{cornflowerblue}{\\texttt{BLUE}}$'}
